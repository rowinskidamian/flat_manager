...
<head>
    ...
    <title>Flat Manager - Potwierdź usunięcie pokoju z mieszkania</title>
    ...
    <div class="container is-fluid">
        <div class="notification">
            <h5 class="title is-5 has-text-centered">Potwierdź usunięcie pokoju</h5>
                <form:form modelAttribute="roomDeleteData" method="post" action="/room/delete_from_property">
                <div class="field is-grouped is-grouped-centered">
                    ...
                    <div class="buttons">
                        ...
                        <a class="button is-light" href="/room/edit_in_property/${roomDeleteData.propertyId}">
                            Anuluj
                        </a>
                    </div>
                    </p>
