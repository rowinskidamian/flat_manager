...
<section class="section">
    <div class="container is-fluid">
        <div class="notification">
            <h5 class="title is-5 has-text-centered">Potwierdź usunięcie najemcy</h5>
            <form:form modelAttribute="tenantData" method="post" action="/tenant/delete">
                ...
                <input hidden name="id" value="${tenantData.id}">
